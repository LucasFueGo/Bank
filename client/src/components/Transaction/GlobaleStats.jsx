...
const GlobaleStats = ({ title = "Vue d'ensemble", refreshTrigger = 0, showSwitch = true }) => {
    ...
    const isMonthly = !showSwitch || viewMode === VIEW_MODES.MONTH;
    ...
    useEffect(() => {
        ...
        fetchData();
    }, [month, year, viewMode, refreshTrigger, isMonthly]);    
